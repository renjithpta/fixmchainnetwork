...
const isUserRegistered = async (username, userOrg) => {
    ...
    const userIdentity = await wallet.get(username);
    console.log("=======isReguistered====",userIdentity,username)
    if (userIdentity) {
...
const registerAndGerSecret = async (username, userOrg) => {
    ...
    console.log("========================in===============",username,userOrg)

    let result = await isUserRegistered(username,userOrg)
    ...
    const userIdentity = await wallet.get(username);
    console.log("Identity===",userIdentity,username)
    if (userIdentity) {
        console.log(`An identity for the user ${username} already exists in the wallet`);
        var response = {
            success: true,
